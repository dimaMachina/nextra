...
import { FileTree, Steps } from '@nextra/ui'
...
>
> Checkout Nextra's
> [docs website](https://github.com/dimaMachina/nextra/tree/main/examples/docs)
> and
> [i18n website example](https://github.com/dimaMachina/nextra/tree/main/examples/swr-site).
