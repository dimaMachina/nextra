...
export default {
  project: {
    link: 'https://github.com/dimaMachina/nextra' // GitHub link in the navbar
  },
  docsRepositoryBase: 'https://github.com/dimaMachina/nextra/blob/master', // base URL for the docs repository
  getNextSeoProps: () => ({ titleTemplate: '%s – Nextra' }),
  navigation: true,
  darkMode: true,
  footer: {
    text: `MIT ${new Date().getFullYear()} © Dimitri POSTOLOV.`
  },
  editLink: {
...
> title. <br /> Check the source code: https://github.com/dimaMachina/nextra for
> more information.
